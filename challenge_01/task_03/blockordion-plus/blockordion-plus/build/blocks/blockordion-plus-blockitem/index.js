...
/* harmony import */ var _lib_tools_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../lib/tools.js */ "./src/lib/tools.js");
/* harmony import */ var _wordpress_icons__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @wordpress/icons */ "./node_modules/@wordpress/icons/build-module/library/plus-circle-filled.js");
...
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./editor.scss */ "./src/blocks/blockordion-plus-blockitem/editor.scss");
...
function Edit(props) {
  ...
  const ALLOWED_BLOCKS = wp.blocks.getBlockTypes().map(block => block.name).filter(blockName => {
    return blockName !== 'imandresi/blockordion-plus' && blockName !== 'imandresi/blockordion-plus-blockitem';
  });
  ...
  function addItemAbove() {
    const rootClientId = (0,_lib_tools_js__WEBPACK_IMPORTED_MODULE_4__.blockEditor)().getBlockHierarchyRootClientId(clientId);
    const clientIndex = (0,_lib_tools_js__WEBPACK_IMPORTED_MODULE_4__.blockEditor)().getBlockIndex(clientId);
    const block = wp.blocks.createBlock('imandresi/blockordion-plus-blockitem', {});
    (0,_lib_tools_js__WEBPACK_IMPORTED_MODULE_4__.blockEditor)().insertBlocks(block, clientIndex, rootClientId);
  }
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("section", {
    className: className,
    ...blockProps
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.BlockControls, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.Toolbar, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.DropdownMenu, {
    className: "",
